...
Below is a descripter of a boot firmware in which ME region exists but is not locked, printed by `flashrom(8)`:
...
Region 2 (ME    ) 0x00003000 - 0x002fffff
